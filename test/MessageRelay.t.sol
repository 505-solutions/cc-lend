...
//             address(ethAsset), address(0xc89b59096964e48c6A1456c08a94D6b2A0f6Fa5B), 0.5e18, 0
//         );
//         ethPool.setInterestRateModel(address(ethAsset), address(interestRateModel));
//         flarePool.configureAsset(
//             address(flareAsset), address(0x65d6a4ee7b2a807993b7014247428451aE11a471), 0.5e18, 0
//         );
...
//         ethPool.configureAsset(
//             address(ethBorrowAsset), address(0x013bbC069FdD066009e0701Fe9969d4dDf3c7e4E), 0, 1e18
//         );
